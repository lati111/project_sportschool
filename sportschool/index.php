  ...
  <div class="container">
    <div class="row">
      <div class="col-12">
        <nav class="main-nav">
          <!-- ***** Logo ***** -->
          <a href="index.php" class="logo">Sport<em>school</em></a>
          <!-- ***** Menu ***** -->
          <ul class="nav">
            ...
            <li class="scroll-to-section"><a href="#sign-in">Sign In</a></li>
          </ul>
    ...
    <div class="row">
      <div class="col-lg-10 offset-lg-1">
        <div class="cta-content">
          ...
          <p>Just start and move your body.</p>
          <div class="main-button scroll-to-section">
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-6 col-md-6 col-xs-12">
        <div id="map">
          <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2056.8872832220645!2d5.079897926149622!3d51.571020185679444!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47c6be27c4cb94c3%3A0xa679b025c87c6c9!2sROC%20Tilburg!5e0!3m2!1snl!2snl!4v1617777223988!5m2!1snl!2snl"
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 contact-form">
        <form id="signin" action="cursist_verificatie.php" method="post">
          <div class="row">
            <div class="col-sm-12">
              <fieldset>
                  <?php
            ...
            <div class="col-sm-12">
                ...
                for ($s = '', $i = 0, $z = strlen($a = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789')-1; $i != 12; $x = rand(0,$z), $s .= $a{$x}, $i++) {
                    ...
                    switch (rand(1, 6)) {
                        case 1:
                            echo "<label>Pak alleen de hoofdletters!</label>";
                            echo "<input type='text' name='captchaType' style='display: none;' value='upperOnly'></input>";
                            break;
                        case 2:
                            echo "<label>Pak alleen de kleine letters!</label>";
                            echo "<input type='text' name='captchaType' style='display: none;' value='lowerOnly'></input>";
                            break;
                        case 3:
                            echo "<label>Pak alleen de cijfers!</label>";
                            echo "<input type='text' name='captchaType' style='display: none;' value='numberOnly'></input>";
                            break;
                        case 4:
                            echo "<label>Pak alleen de letters!</label>";
                            echo "<input type='text' name='captchaType' style='display: none;' value='noNumbers'></input>";
                            break;
                        case 5:
                            echo "<label>Pak alleen de hoofdletters en cijfers!</label>";
                            echo "<input type='text' name='captchaType' style='display: none;' value='noLower'></input>";
                            break;
                        case 6:
                            echo "<label>Pak alleen de kleine letters en cijfers!</label>";
                            echo "<input type='text' name='captchaType' style='display: none;' value='noUpper'></input>";
                            break;
                    }
                echo "<br><input type='text' name='captchaString' style='display: none' value='" . $string . "'>" . $string . "</input>";
                ?>
